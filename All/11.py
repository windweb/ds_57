...
Переменная subsample создается путем вызова метода sample() с аргументом n, установленным в 25, чтобы получить подвыборку из 25. Аргумент replace=True устанавливается для включения выборки с заменой.
